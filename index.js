    ...
    try {
        if (user.vendor !== null) {
            ...
            let result = transporter.sendMail({
                ...
                to: `${copy}, nick.of.darkwood@gmail.com`, // `${recipient}, `
...
const start = async () => {
    ...
    теперь поиск на нём осуществляется по артикулу товара.
    Так же при скидке на товар зачеркивается старая цена
    и рядом пишется новая. 
    ------------------------------------
    <b>Версия 1.0.4.4
    Что нового:</b>

    Добавлен поиск по остаткам обоев следующих брендов:
